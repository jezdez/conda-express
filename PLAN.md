...
- **conda-pypi**: conda-forge only, depends on `conda-index`. Provides `conda pypi install`, `conda pypi convert`, experimental wheel channels in repodata (draft CEP-145), editable/VCS package support, PEP-668 `EXTERNALLY-MANAGED` marker integration
